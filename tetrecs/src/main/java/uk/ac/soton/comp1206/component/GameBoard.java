...
public class GameBoard extends GridPane {
     ...
     * columns and rows, along with the
    ...
    /**
     * Triggered when a block is clicked(left or right). Call the attached listener.
     * 
