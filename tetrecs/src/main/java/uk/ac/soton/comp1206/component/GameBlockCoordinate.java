...
/**
 * Represents a row and column representation of a block in the grid. Holds the
 * x (column) and y (row).
 *
...
public class GameBlockCoordinate {
    ...
    /**
     * A hash is computed to enable comparisons between this and other
     * GameBlockCoordinates.
     */
    private int hash = 0;

    /**
     * Create a new GameBlockCoordinate which stores a row and column reference to a
     * block
     * 
     * @param x column
     * @param y row
    ...
    /**
     * Add a row and column reference to this one and return a new
     * GameBlockCoordinate
     * 
    ...
    /**
     * Add another GameBlockCoordinate to this one, returning a new
     * GameBlockCoordinate
     * 
    ...
    /**
     * Subtract a row and column reference to this one and return a new
     * GameBlockCoordinate
     * 
    ...
    /**
     * Subtract another GameBlockCoordinate to this one, returning a new
     * GameBlockCoordinate
     * 
